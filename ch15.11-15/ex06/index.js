...
// sessionStorageに保存されているToDoリストを取得して表示する
const getTodosFromSessionStorage = () => {
  try {
    ...
    // sessionStorageが使えない場合はlogに出力するだけ
    console.log("can not use sessionStorage");
  }
};

// sessionStorageにToDoリストを保存する
